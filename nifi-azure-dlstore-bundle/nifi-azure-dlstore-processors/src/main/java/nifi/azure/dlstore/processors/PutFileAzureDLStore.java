...
public class PutFileAzureDLStore extends AbstractProcessor {
    ...
    public void onTrigger(final ProcessContext context, final ProcessSession session) throws ProcessException {
        ...
        _adlsAccountName = adlService.getProperty("DATALAKE_ACCOUNT_NAME");
        _resourceGroupName = adlService.getProperty("RESOURCE_GROUP_NAME");
        _location = adlService.getProperty("LOCATION");
        _tenantId = adlService.getProperty("TENANT_ID");
        _subId = adlService.getProperty("SUB_ID");
        ...
        try
        {
            ...
            _adlsFileSystemClient = adlService.getAdlsFileSystemClient();
            ...
            {
                AzureSDKWrapperObject.DLCreateFile(_adlsClient, _adlsFileSystemClient, _adlsAccountName, _path + _filename, value.get(), true);
                //CreateFile(_path + _filename, value.get(), true);
            }
            else
            {
                AzureSDKWrapperObject.DLCreateFile(_adlsClient, _adlsFileSystemClient, _adlsAccountName, _path + _filename, value.get(), false);
    ...
    public static void CreateFile(String path) throws IOException, AdlsErrorException {
        _adlsFileSystemClient.fileSystems().create(_adlsAccountName, path);
    }
    ...
    public static void CreateFile(String path, String contents, boolean force) throws IOException, AdlsErrorException {
        ...
        _adlsFileSystemClient.fileSystems().create(_adlsAccountName, path, bytesContents, force);
    }
}